...
Formation c#";
            ...
            //Fonction: méthode qui renvoi un resultat un résultat
            ...
            int[] tableau1 = { 10, 0, 20, 15 };

            Console.WriteLine("Tableau1:");
            MesMethodes.Afficher(tableau1);
            ...
            Console.WriteLine("Une méthode qui renvoie la somme des éléments d'un tableau d'entiers(tableau 1 et 2)");
            Console.WriteLine(MesMethodes.Somme(tableau1));
            Console.WriteLine(MesMethodes.Somme(tableau2));

            Console.WriteLine("Une méthode qui renvoie la somme des éléments d'un tableau d'entiers(tableau 1 et 2) -- Version du cours");
            Console.WriteLine(MesMethodes.SommeElements(tableau1));
            Console.WriteLine(MesMethodes.SommeElements(tableau2));

            Console.WriteLine("Une méthode qui renvoie la moyenne des élémenets d'un tableau d'entiers (tableau 1 et 2)");
            Console.WriteLine(MesMethodes.Mean(tableau1));
            Console.WriteLine(MesMethodes.Mean(tableau2));

            Console.WriteLine("Une méthode qui renvoie la moyenne des élémenets d'un tableau d'entiers (tableau 1 et 2) -- Version du cours");
            Console.WriteLine(MesMethodes.Moyenne(tableau1));
            Console.WriteLine(MesMethodes.Moyenne(tableau2));

            Console.WriteLine("Une méthode qui renvoie l'élément le plus petit d'un tableau d'entiers (tableau 1 et 2)");
            Console.WriteLine(MesMethodes.Min(tableau1));
            Console.WriteLine(MesMethodes.Min(tableau2));

            Console.WriteLine("Une méthode qui renvoie l'élément le plus petit d'un tableau d'entiers (tableau 1 et 2) -- Version du cours");
            Console.WriteLine(MesMethodes.Minimum(tableau1));
            Console.WriteLine(MesMethodes.Minimum(tableau2));


            MesMethodes.SommeOptionel(10, 20); // On obtient 40
            MesMethodes.SommeOptionel(10, 20, 40); // On obtient 70

            int valeur1 = 10, valeur2 = 20;
            Console.WriteLine($"Avant permutation");

            //Appel des méthodes avec param en sortie
            int a = 10, b = 20;
            ...
            Console.WriteLine($"produit = {sommeSortie}");
            Console.WriteLine($"produit = {moyenneSortie}");
            ...
            if (conversion)
            {
                Console.WriteLine($"Conversion Réussi - numConvert = {numConvert}");
            }
            else
            {
